...
if __name__ == "__main__":
    ...
    fu0lsplit = np.array_split(fu0l, 10)
    
    processes = []
    for fu0l in fu0lsplit:
        #task_manager(filenamein, falpha, fu0, lockbinaryfail, locknotcb, lockmem)
        p = multiprocessing.Process(target=task_manager, args=(filenamein, falphal, fu0l, lockbinaryfail, locknotcb, lockmem))
        processes.append(p)
        p.start()
